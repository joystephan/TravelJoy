...
const appError = new errors_1.AppError("Generic error", 500, "GENERIC_ERROR");
...
console.log("\n✓ Test 2: ValidationError");
const validationError = new errors_1.ValidationError("Invalid input data");
...
console.log("\n✓ Test 3: AuthenticationError");
const authError = new errors_1.AuthenticationError("Invalid credentials");
...
console.log("\n✓ Test 4: NotFoundError");
const notFoundError = new errors_1.NotFoundError("Trip not found");
...
console.log("\n✓ Test 5: ExternalAPIError");
const externalError = new errors_1.ExternalAPIError("Weather API failed");
...
console.log("\n✓ Test 6: Error Inheritance");
console.log(`  - ValidationError instanceof AppError: ${validationError instanceof errors_1.AppError}`);
console.log(`  - ValidationError instanceof Error: ${validationError instanceof Error}`);
